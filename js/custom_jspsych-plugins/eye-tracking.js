  ...
  plugin.info = {
    ...
    parameters: {
      ...
      calibrationMessage: {
        ...
        <p>We will now perform the eye tracking calibration. During calibration, you will see a series of dots like this:</p>
        <span id="calibration_dot_instruction"></span>
        <p>Your task is simply to stare directly at each dot until it disappears. Then, quickly move your eyes to the next dot and repeat.</p>
      ...
      validationMessage: {
        ...
        <p>Now, we need to validate the calibration. Again, please stare at each dot until it turns <strong><font color='green'>green</font></strong> and disappears. A dot may turn <strong><font color='yellow'>yellow</font></strong>, indicating that you don't seem to be staring directly at it.<br>
        Try to prevent this from happening!</p>
        <p>Press <strong><em>SPACE BAR</em></strong> to start.</p>
        </div>`,
      ...
      faceDetectionMessage: {
        ...
        default: `
        <div style="max-width: 800px">
        <h1>Step 1: Camera setup</h1>
        <p align="justify">To start, you need to position your head so that the webcam has a good view of your eyes. Use the video in the upper-left corner as a guide. Center your face in the box. The goal is to align the green face-mask with your face, <strong>especially your eyes</strong> like this:</p>
        <img src='img/et-instructions/et-instruct_0.png' width=30%>
        <p align="justify">Use these tips to achieve a good quality fit:<p>
        <img src='img/et-instructions/et-instruct_1.png' width=100%>
        <p align="justify">Try to change the lighting if you cannot achieve a good quality fit. Sometimes, slowly moving your head to "slide into" the mask can also improve the fit.</p>
        <p>Once you reached the necessary quality as indicated by the meter below, press the <strong><em>SPACE BAR</em></strong> to continue.</p>
        </div>`,
